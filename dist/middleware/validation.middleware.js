...
export const validatePhoneNumber = (fieldName) => {
    return (req, res, next) => {
...
export const validateArrayLength = (fieldName, minLength, maxLength) => {
    return (req, res, next) => {
...
export const validateFileSize = (fieldName, maxSizeBytes) => {
    return (req, res, next) => {
        const file = req.file;
...
export const validateFileType = (fieldName, allowedTypes) => {
    return (req, res, next) => {
        const file = req.file;
...
export const sanitizeInput = (_req, _res, next) => {
    // Sanitize input data
