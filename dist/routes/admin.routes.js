...
router.get('/vendors', authMiddleware, requireAdmin, async (_req, res) => {
    try {
...
router.put('/users/:id/role', authMiddleware, requireAdmin, async (_req, res) => {
    try {
...
router.put('/vendors/:id/approval', authMiddleware, requireAdmin, async (_req, res) => {
    try {
