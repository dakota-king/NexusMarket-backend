...
export const dynamicRateLimit = (baseLimit: number = 100) => {
  return rateLimit({
    windowMs: 60000,
    max: (req) => {
...
export const ipBasedRateLimit = (maxRequests: number = 100, windowMs: number = 60000) => {
  return rateLimit({
    windowMs,
    max: maxRequests,
...
export const userBasedRateLimit = (maxRequests: number = 200, windowMs: number = 60000) => {
  return rateLimit({
    windowMs,
    max: maxRequests,
...
export const burstRateLimit = (maxRequests: number = 20, windowMs: number = 10000) => {
  return rateLimit({
    windowMs,
    max: maxRequests,
    standardHeaders: true,
